 ...
 */
@Deprecated(
    message = "MultiItemTypePagedListAdapter is deprecated and has been replaced by MultiItemTypePagingDataAdapter",
    replaceWith = ReplaceWith(
        "MultiItemTypePagingDataAdapter<T, VH>",
        "top.laoshuzi.rvbaseadapter.paging.MultiItemTypePagingDataAdapter"
    )
)
abstract class MultiItemTypePagedListAdapter<T : Any> : PagedListAdapter<T, ViewHolder> {
    ...
    open fun addItemViewDelegate(itemViewDelegate: ItemViewDelegate<T>): MultiItemTypePagedListAdapter<T> {
    ...
    ): MultiItemTypePagedListAdapter<T> {
